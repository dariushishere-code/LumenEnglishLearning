import { a as encodePathLikeUrl, c as hasKeys, f as last, i as deepEqual, l as isAbsoluteUrl, m as replaceEqualDeep, n as arraysEqual, p as nullReplaceEqualDeep, r as decodePath, s as functionalUpdate, t as DEFAULT_PROTOCOL_ALLOWLIST, u as isDangerousProtocol } from "./utils-DTBDoUJi.mjs";
import { C as trimPath, O as useLayoutEffect, S as routerContext, T as trimPathRight, a as buildRouteBranch, b as require_react, d as findSingleMatch, f as interpolatePath, g as processRouteTree, h as processRouteMasks, i as __toESM, k as useRouter, l as findFlatMatch, m as joinPaths, n as __commonJSMin, o as compileDecodeCharMap, p as invariant, s as createSieveCache, t as ClientOnly, u as findRouteMatch, x as resolvePath, y as require_jsx_runtime } from "./useStore-ID5WVn9Q.mjs";
import { i as redirect, n as isResolvedRedirect, r as parseRedirect, t as isRedirect } from "./redirect-2EvM1wXL.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/matchContext-D-1h983U.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/Match-BkBSXpTi.js
...
function ErrorComponent({ error }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", { style: { height: ".25rem" } }),
			show ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("pre", {
				style: {
					fontSize: ".7em",
				...
				children: error?.message ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("code", { children: error.message }) : null
			}) }) : null
		]
	});
}
function CatchNotFound(props) {
	const router = useRouter();
	{
		...
		return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(CatchBoundary, {
...
function DefaultGlobalNotFound() {
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("p", { children: "Not Found" });
}
/**
...
function ScriptOnce({ children }) {
	const router = useRouter();
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("script", {
		nonce: router.options.ssr?.nonce,
		dangerouslySetInnerHTML: { __html: children + ";document.currentScript.remove()" }
	});
}
function SafeFragment(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(import_jsx_runtime$1.Fragment, { children: props.children });
}
/**
...
function renderRouteNotFound(router, route, data) {
	if (!route.options.notFoundComponent) {
		if (router.options.defaultNotFoundComponent) return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(router.options.defaultNotFoundComponent, { ...data });
		return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(DefaultGlobalNotFound, {});
	}
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(route.options.notFoundComponent, { ...data });
}
...
function ScrollRestoration() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(ScriptOnce, { children: script });
}
function renderPending(router, route) {
	const PendingComponent = route?.options.pendingComponent ?? router.options.defaultPendingComponent;
	if (!PendingComponent) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(PendingComponent, {});
}
...
var Match = import_react.memo(function MatchImpl({ routeId }) {
	const router = useRouter();
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(MatchView, {
		router,
...
function MatchView({ router, match }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)(route.isRoot ? route.options.shellComponent ?? SafeFragment : SafeFragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(matchContext.Provider, {
		value: match.routeId,
		children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(ResolvedSuspenseBoundary, {
			fallback: pendingElement,
			children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(ResolvedCatchBoundary, {
				getResetKey: () => match,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(ResolvedNotFoundBoundary, {
					fallback: (error) => {
						error.routeId ??= match.routeId;
						if (error.routeId !== match.routeId) throw error;
						return import_react.createElement(routeNotFoundComponent, error);
					},
					children: resolvedNoSsr ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(ClientOnly, {
						fallback: pendingElement,
						children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(MatchInner, { match })
					}) : /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(MatchInner, { match })
				})
			})
		})
	}), route.parentRoute?.id === "__root__" && router.options.scrollRestoration ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(ScrollRestoration, {}) : null] });
}
var MatchInner = import_react.memo(function MatchInnerImpl({ match }) {
	...
	const out = import_react.useMemo(() => {
		...
		return Comp ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Comp, {}, key) : /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Outlet, {});
	}, [
		key,
	...
	if (match.status === "error") return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)((route.options.errorComponent ?? router.options.defaultErrorComponent) || ErrorComponent, {
		error: match.error,
		reset: void 0,
		info: { componentStack: "" }
	});
...
var Outlet = import_react.memo(function OutletImpl() {
	...
	const nextMatch = /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Match, { routeId: childRouteId });
	if (routeId === "__root__") return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(import_react.Suspense, {
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/createServerFn-D3_iz8zq.js
...
if (!globalObj$1[GLOBAL_STORAGE_KEY]) globalObj$1[GLOBAL_STORAGE_KEY] = new AsyncLocalStorage$1();
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/__23tanstack-start-server-fn-resolver-BkOZ3XOd.js
var manifest = { "e750fb4bcb19c2a90853276e249ec2a6fa6041357329ea90d63f30473e2d533c": {
	functionName: "askCoach_createServerFn_handler",
	importer: () => import("./chat-CgeA1_Nf.mjs")
} };
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B2Yus2G_.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D4kp1u6Z.mjs").then((n) => n.t),
...
//#endregion
export { Outlet as a, appendUniqueUserTags as c, createServerEntry, getAssetCrossOrigin as d, worker_entry_default as default, getScriptPreloadAttrs as f, rootRouteId as g, matchContext as h, createServerFn as i, createNonReactiveMutableStore as l, dummyMatchContext as m, getServerFnById as n, RouterCore as o, resolveManifestCssLink as p, TSS_SERVER_FUNCTION as r, _getAssetMatches as s, ssr_exports as t, createNonReactiveReadonlyStore as u };
